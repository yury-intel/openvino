...
class Psroipooling : public BasicBF16Test {
protected:
...
TEST_P(Psroipooling, CompareWithRefImpl) {
    test();
}

INSTANTIATE_TEST_CASE_P(FP32_bfloat16_NoReshape, Psroipooling,
                        ::testing::Combine(
