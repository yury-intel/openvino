...
class Psroipooling_before_conv_deformable : public BasicBF16Test {
protected:
    std::shared_ptr<ngraph::Function> createGraph(InferenceEngine::Precision netPrecision) override {
        ...
        int spatial_bins_x = 3;
        int spatial_bins_y = 3;
        ...
        auto psroi_pool = make_shared<ngraph::opset1::DeformablePSROIPooling>(input1, coords, offsets, output_dim,
        ...
        weightValuesFP32.resize(channelsCount2 * channelsCount2 * 3 * 3);
...
TEST_P(Psroipooling_before_conv_deformable, CompareWithRefImpl) {
    test();
}

INSTANTIATE_TEST_CASE_P(FP32_bfloat16_NoReshape, Psroipooling_before_conv_deformable,
                        ::testing::Combine(
                                ::testing::Values(Precision::FP32),
                                ::testing::Values(Precision::FP32),
                                ::testing::Values(SizeVector({ 1, 1, 10, 10 })),
                                ::testing::Values(SizeVector()),
                                ::testing::Values(CommonTestUtils::DEVICE_CPU)),
                        Psroipooling_before_conv_deformable::getTestCaseName);
}  // namespace LayerTestsDefinitions
