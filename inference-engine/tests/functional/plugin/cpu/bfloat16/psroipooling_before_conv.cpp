...
class Psroipooling_before_conv : public BasicBF16Test {
protected:
    std::shared_ptr<ngraph::Function> createGraph(InferenceEngine::Precision netPrecision) override {
        ...
        auto psroi_pool = make_shared<ngraph::opset1::PSROIPooling>(input1, coords, output_dim, group_size,
...
TEST_P(Psroipooling_before_conv, CompareWithRefImpl) {
    test();
}

INSTANTIATE_TEST_CASE_P(FP32_bfloat16_NoReshape, Psroipooling_before_conv,
                        ::testing::Combine(
                        ...
                        Psroipooling_before_conv::getTestCaseName);
}  // namespace LayerTestsDefinitions
