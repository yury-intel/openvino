...
class Psroipooling_conv_x2_deformable : public BasicBF16Test {
protected:
...
TEST_P(Psroipooling_conv_x2_deformable, CompareWithRefImpl) {
    test();
}

INSTANTIATE_TEST_CASE_P(FP32_bfloat16_NoReshape, Psroipooling_conv_x2_deformable,
                        ::testing::Combine(
                        ...
                        Psroipooling_conv_x2_deformable::getTestCaseName);
}  // namespace LayerTestsDefinitions
