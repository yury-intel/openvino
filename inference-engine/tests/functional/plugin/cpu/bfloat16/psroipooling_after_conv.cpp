...
class Psroipooling_after_conv : public BasicBF16Test {
protected:
...
TEST_P(Psroipooling_after_conv, CompareWithRefImpl) {
    test();
}

INSTANTIATE_TEST_CASE_P(FP32_bfloat16_NoReshape, Psroipooling_after_conv,
                        ::testing::Combine(
                        ...
                        Psroipooling_after_conv::getTestCaseName);
}  // namespace LayerTestsDefinitions
