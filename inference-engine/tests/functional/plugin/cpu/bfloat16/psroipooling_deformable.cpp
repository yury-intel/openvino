...
class Psroipooling_deformable : public BasicBF16Test {
protected:
...
TEST_P(Psroipooling_deformable, CompareWithRefImpl) {
    test();
}

INSTANTIATE_TEST_CASE_P(FP32_bfloat16_NoReshape, Psroipooling_deformable,
                        ::testing::Combine(
                        ...
                        Psroipooling_deformable::getTestCaseName);
}  // namespace LayerTestsDefinitions
